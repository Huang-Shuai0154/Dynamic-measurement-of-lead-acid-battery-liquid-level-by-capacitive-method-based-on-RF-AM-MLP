...
X = np.hstack((all_avg_C, all_delta_C_window))  # 现在是电容平均值、变化量、振幅和频率作为特征
...
torch.save(model.state_dict(), "No_RF_no_attention_model_Circuit.pth")
joblib.dump(scaler, "Scaler_no_RF_Circuit.pkl")